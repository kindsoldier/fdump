...
func (util *Util) GetStatusCmd(auth *dsrpc.Auth) (*fdmapi.GetStatusResult, error) {
    var err error
    params := fdmapi.NewGetStatusParams()
    result := fdmapi.NewGetStatusResult()
    err = dsrpc.Exec(util.URI, fdmapi.GetStatusMethod, params, result, auth)
    if err != nil {
        return result, err
    }
    return result, err
...
func (util *Util) AddUserCmd(auth *dsrpc.Auth) (*fdmapi.AddUserResult, error) {
    var err error
    params := fdmapi.NewAddUserParams()
    params.Login    = util.Login
    params.Pass     = util.Pass
    result := fdmapi.NewAddUserResult()
    err = dsrpc.Exec(util.URI, fdmapi.AddUserMethod, params, result, auth)
    if err != nil {
        return result, err
    }
    return result, err
...
func (util *Util) CheckUserCmd(auth *dsrpc.Auth) (*fdmapi.CheckUserResult, error) {
    var err error
    params := fdmapi.NewCheckUserParams()
    params.Login    = util.Login
    params.Pass     = util.Pass
    result := fdmapi.NewCheckUserResult()
    err = dsrpc.Exec(util.URI, fdmapi.CheckUserMethod, params, result, auth)
    if err != nil {
        return result, err
    }
    return result, err
...
func (util *Util) UpdateUserCmd(auth *dsrpc.Auth) (*fdmapi.UpdateUserResult, error) {
    var err error
    params := fdmapi.NewUpdateUserParams()
    params.Login    = util.Login
    params.Pass     = util.Pass
    result := fdmapi.NewUpdateUserResult()
    err = dsrpc.Exec(util.URI, fdmapi.UpdateUserMethod, params, result, auth)
    if err != nil {
        return result, err
    }
    return result, err
...
func (util *Util) DeleteUserCmd(auth *dsrpc.Auth) (*fdmapi.DeleteUserResult, error) {
    var err error
    params := fdmapi.NewDeleteUserParams()
    params.Login    = util.Login
    result := fdmapi.NewDeleteUserResult()
    err = dsrpc.Exec(util.URI, fdmapi.DeleteUserMethod, params, result, auth)
    if err != nil {
        return result, err
    }
    return result, err
...
func (util *Util) ListUsersCmd(auth *dsrpc.Auth) (*fdmapi.ListUsersResult, error) {
    var err error
    params := fdmapi.NewListUsersParams()
    result := fdmapi.NewListUsersResult()
    err = dsrpc.Exec(util.URI, fdmapi.ListUsersMethod, params, result, auth)
    if err != nil {
        return result, err
    }
    return result, err
