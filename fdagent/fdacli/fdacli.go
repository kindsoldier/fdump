...
func (util *Util) GetStatusCmd(auth *dsrpc.Auth) (*fdaapi.GetStatusResult, error) {
    var err error
    params := fdaapi.NewGetStatusParams()
    result := fdaapi.NewGetStatusResult()
    err = dsrpc.Exec(util.URI, fdaapi.GetStatusMethod, params, result, auth)
    if err != nil {
        return result, err
    }
    return result, err
...
func (util *Util) AddUserCmd(auth *dsrpc.Auth) (*fdaapi.AddUserResult, error) {
    var err error
    params := fdaapi.NewAddUserParams()
    params.Login    = util.Login
    params.Pass     = util.Pass
    result := fdaapi.NewAddUserResult()
    err = dsrpc.Exec(util.URI, fdaapi.AddUserMethod, params, result, auth)
    if err != nil {
        return result, err
    }
    return result, err
...
func (util *Util) CheckUserCmd(auth *dsrpc.Auth) (*fdaapi.CheckUserResult, error) {
    var err error
    params := fdaapi.NewCheckUserParams()
    params.Login    = util.Login
    params.Pass     = util.Pass
    result := fdaapi.NewCheckUserResult()
    err = dsrpc.Exec(util.URI, fdaapi.CheckUserMethod, params, result, auth)
    if err != nil {
        return result, err
    }
    return result, err
...
func (util *Util) UpdateUserCmd(auth *dsrpc.Auth) (*fdaapi.UpdateUserResult, error) {
    var err error
    params := fdaapi.NewUpdateUserParams()
    params.Login    = util.Login
    params.Pass     = util.Pass
    result := fdaapi.NewUpdateUserResult()
    err = dsrpc.Exec(util.URI, fdaapi.UpdateUserMethod, params, result, auth)
    if err != nil {
        return result, err
    }
    return result, err
...
func (util *Util) DeleteUserCmd(auth *dsrpc.Auth) (*fdaapi.DeleteUserResult, error) {
    var err error
    params := fdaapi.NewDeleteUserParams()
    params.Login    = util.Login
    result := fdaapi.NewDeleteUserResult()
    err = dsrpc.Exec(util.URI, fdaapi.DeleteUserMethod, params, result, auth)
    if err != nil {
        return result, err
    }
    return result, err
...
func (util *Util) ListUsersCmd(auth *dsrpc.Auth) (*fdaapi.ListUsersResult, error) {
    var err error
    params := fdaapi.NewListUsersParams()
    result := fdaapi.NewListUsersResult()
    err = dsrpc.Exec(util.URI, fdaapi.ListUsersMethod, params, result, auth)
    if err != nil {
        return result, err
    }
    return result, err
